...
EOF
	...
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ~/build-yocto-4SBCs/radxa/patches/rk3399.conf ::/extlinux/extlinux.conf
	...
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ~/build-yocto-4SBCs/radxa/patches/hw_intfc.conf ::/
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ~/build-yocto-4SBCs/radxa/patches/pwm.dtbo ::/overlays/
	# Burn Boot Partition
